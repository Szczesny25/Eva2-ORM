...
class ProyectoControllerSwagger extends Controller
{
    ...
    {
        $query = Proyecto::orderByDesc('created_at');

        // La paginación es opcional: si no mandan limit/offset, se devuelven
        // TODOS los proyectos (así se cumple el requisito de "listar todos").
        ...
        // Si no hay proyectos en la BD, get() devuelve una colección vacía,
        // que al convertirla a JSON queda como un arreglo vacio [].
   ...
   #[OA\Delete(
       ...
       responses: [
           new OA\Response(
               response: 204,
               description: 'se muricio solo D: (sin contenido)'
           ),
           new OA\Response(
               response: 404 ,
               description: 'no eta'
   ...
   public function destroy($id)
   {
       ...
       // El requisito pide 204: sin cuerpo en la respuesta.
